...
<p align="center">
  <img width="360" height="360" src="demo.gif">
</p>
<p align="center">Starry Cube</p>
...
- Vertex deform via smoothstepped 3D value noise

Fragment shader:

- Wavy 3D Musgrave FBM noise for "outer space"-like effect
- "Stars" via 3D Perlin noise
